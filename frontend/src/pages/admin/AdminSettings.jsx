      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="skeleton"
            style={{ height: "56px", borderRadius: "var(--radius)" }}
          />
        ))}
      </div>
    );
            ...
            >
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Jitendra Jaiswar — Developer"
                  {...register("site_title")}
                />
              </div>
              <div className="form-group">
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    <Download size={13} /> Enable Resume Download
                  </div>
                  <div
                    style={{
                      fontSize: "0.75rem",
                  ...
                  >
                    Show download CV button on About page
                  </div>
                </div>
              </label>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <AlertTriangle size={13} /> Maintenance Mode
                  </div>
                  <div
                    style={{
                      fontSize: "0.75rem",
                  ...
                  >
                    Show a coming-soon page to visitors (admin still has access)
                  </div>
                </div>
              </label>
            </div>
